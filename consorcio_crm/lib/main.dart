...
Future<void> main() async {
  // Garante que o Flutter esteja pronto antes de chamar pacotes nativos/web
...
class ConsorcioCRMApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Lemos a configuração de rotas que criamos
    final router = ref.watch(goRouterProvider);

    return MaterialApp.router(
      title: 'Portal de Vendas CRM',
      debugShowCheckedModeBanner: false,
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: const Color(0xFF1E3A8A)),
        useMaterial3: true,
      ),
      // Passamos o router para o MaterialApp
      routerConfig: router, 
    );
  }
}
